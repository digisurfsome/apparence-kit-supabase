...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id, @TimestampConverter()  DateTime creationDate, @TimestampConverter()  DateTime lastUpdateDate,  Map<String, String> title,  Map<String, String> description,  int votes,  bool active)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case FeatureRequestEntityData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id, @TimestampConverter()  DateTime creationDate, @TimestampConverter()  DateTime lastUpdateDate,  Map<String, String> title,  Map<String, String> description,  int votes,  bool active)  $default,) {final _that = this;
switch (_that) {
case FeatureRequestEntityData():

...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id, @JsonKey(name: 'creation_date')@TimestampConverter()  DateTime creationDate,  String userId,  String featureId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case UserFeatureVoteEntityData() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id, @JsonKey(name: 'creation_date')@TimestampConverter()  DateTime creationDate,  String userId,  String featureId)  $default,) {final _that = this;
switch (_that) {
case UserFeatureVoteEntityData():
return $default(_that.id,_that.creationDate,_that.userId,_that.featureId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id, @JsonKey(name: 'creation_date')@TimestampConverter()  DateTime creationDate,  String userId,  String featureId)?  $default,) {final _that = this;
switch (_that) {
case UserFeatureVoteEntityData() when $default != null:
return $default(_that.id,_that.creationDate,_that.userId,_that.featureId);case _:
  return null;

...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id,  String key,  String value)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case UserInfoEntityData() when $default != null:
return $default(_that.id,_that.key,_that.value);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id,  String key,  String value)  $default,) {final _that = this;
switch (_that) {
case UserInfoEntityData():
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id,  String key,  String value)?  $default,) {final _that = this;
switch (_that) {
case UserInfoEntityData() when $default != null:
return $default(_that.id,_that.key,_that.value);case _:
  return null;

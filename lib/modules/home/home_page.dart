import 'package:apparence_kit/core/states/components/maybe_ask_rating.dart';
import 'package:apparence_kit/core/states/components/maybe_show_update_bottom_sheet.dart';
...
import 'package:apparence_kit/modules/subscription/shared/maybeshow_premium.dart';
...
class HomePage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return ConditionalWidgetsEvents(
      eventWidgets: [
        // you can add here widgets that can be shown based on events
        MaybeAskForReview(),
        MaybeAskForRating(),
        MaybeShowPremiumPage(),
        // this widget is used to show the update bottom sheet when a new version is available
        // it will only be shown once per version and user didn't just installed the app 

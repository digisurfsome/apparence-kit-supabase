...
import 'package:apparence_kit/modules/notifications/repositories/background_notification_handler.dart';
  ...
  Future<void> _onMessage(RemoteMessage message) async {
    if (message.notification == null) {
      ...
      switch (message.data['type']) {
        ...
        case 'SUBSCRIPTION_PURCHASE' when message.data.containsKey('price') && message.data.containsKey('currency'):

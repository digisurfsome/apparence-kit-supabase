...
@JsonKey(includeIfNull: false) String? get id;@TimestampConverter() DateTime get creationDate;@TimestampConverter() DateTime get lastUpdateDate; String get installationId; String get token; OperatingSystem get operatingSystem; Map<String, dynamic>? get extraData;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,creationDate,lastUpdateDate,installationId,token,operatingSystem,const DeepCollectionEquality().hash(extraData));

@override
String toString() {
  return 'DeviceEntity(id: $id, creationDate: $creationDate, lastUpdateDate: $lastUpdateDate, installationId: $installationId, token: $token, operatingSystem: $operatingSystem, extraData: $extraData)';
}
...
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? id,@TimestampConverter() DateTime creationDate,@TimestampConverter() DateTime lastUpdateDate, String installationId, String token, OperatingSystem operatingSystem, Map<String, dynamic>? extraData
});
...
/// Create a copy of DeviceEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? creationDate = null,Object? lastUpdateDate = null,Object? installationId = null,Object? token = null,Object? operatingSystem = null,Object? extraData = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? id, @TimestampConverter()  DateTime creationDate, @TimestampConverter()  DateTime lastUpdateDate,  String installationId,  String token,  OperatingSystem operatingSystem,  Map<String, dynamic>? extraData)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case DeviceEntityData() when $default != null:
return $default(_that.id,_that.creationDate,_that.lastUpdateDate,_that.installationId,_that.token,_that.operatingSystem,_that.extraData);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false)  String? id, @TimestampConverter()  DateTime creationDate, @TimestampConverter()  DateTime lastUpdateDate,  String installationId,  String token,  OperatingSystem operatingSystem,  Map<String, dynamic>? extraData)  $default,) {final _that = this;
switch (_that) {
case DeviceEntityData():
return $default(_that.id,_that.creationDate,_that.lastUpdateDate,_that.installationId,_that.token,_that.operatingSystem,_that.extraData);}
}
...
class DeviceEntityData extends DeviceEntity {
  const DeviceEntityData({@JsonKey(includeIfNull: false) this.id, @TimestampConverter() required this.creationDate, @TimestampConverter() required this.lastUpdateDate, required this.installationId, required this.token, required this.operatingSystem, final  Map<String, dynamic>? extraData}): _extraData = extraData,super._();
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,creationDate,lastUpdateDate,installationId,token,operatingSystem,const DeepCollectionEquality().hash(_extraData));
...
/// Create a copy of DeviceEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? creationDate = null,Object? lastUpdateDate = null,Object? installationId = null,Object? token = null,Object? operatingSystem = null,Object? extraData = freezed,}) {

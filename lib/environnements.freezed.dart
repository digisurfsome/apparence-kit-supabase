...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('name', name))..add(DiagnosticsProperty('backendUrl', backendUrl))..add(DiagnosticsProperty('revenueCatAndroidApiKey', revenueCatAndroidApiKey))..add(DiagnosticsProperty('revenueCatIOSApiKey', revenueCatIOSApiKey))..add(DiagnosticsProperty('appStoreId', appStoreId))..add(DiagnosticsProperty('androidInterstitialAdUnitId', androidInterstitialAdUnitId))..add(DiagnosticsProperty('iOSInterstitialAdUnitID', iOSInterstitialAdUnitID))..add(DiagnosticsProperty('mixpanelToken', mixpanelToken))..add(DiagnosticsProperty('authenticationMode', authenticationMode));
}
...
void debugFillProperties(DiagnosticPropertiesBuilder properties) {
  properties
    ...
    ..add(DiagnosticsProperty('name', name))..add(DiagnosticsProperty('backendUrl', backendUrl))..add(DiagnosticsProperty('revenueCatAndroidApiKey', revenueCatAndroidApiKey))..add(DiagnosticsProperty('revenueCatIOSApiKey', revenueCatIOSApiKey))..add(DiagnosticsProperty('androidInterstitialAdUnitId', androidInterstitialAdUnitId))..add(DiagnosticsProperty('iOSInterstitialAdUnitID', iOSInterstitialAdUnitID))..add(DiagnosticsProperty('appStoreId', appStoreId))..add(DiagnosticsProperty('sentryDsn', sentryDsn))..add(DiagnosticsProperty('mixpanelToken', mixpanelToken))..add(DiagnosticsProperty('authenticationMode', authenticationMode));
}

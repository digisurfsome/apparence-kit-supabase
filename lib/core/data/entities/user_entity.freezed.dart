...
@JsonKey(includeIfNull: false, toJson: Converters.id) String? get id;@JsonKey(name: 'creation_date')@TimestampConverter() DateTime? get creationDate;@JsonKey(name: 'last_update_date')@TimestampConverter() DateTime? get lastUpdateDate; String? get name; String? get email; String? get avatarPath; bool? get onboarded; String? get locale;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,creationDate,lastUpdateDate,name,email,avatarPath,onboarded,locale);

@override
String toString() {
  return 'UserEntity(id: $id, creationDate: $creationDate, lastUpdateDate: $lastUpdateDate, name: $name, email: $email, avatarPath: $avatarPath, onboarded: $onboarded, locale: $locale)';
}
...
@useResult
$Res call({
@JsonKey(includeIfNull: false, toJson: Converters.id) String? id,@JsonKey(name: 'creation_date')@TimestampConverter() DateTime? creationDate,@JsonKey(name: 'last_update_date')@TimestampConverter() DateTime? lastUpdateDate, String? name, String? email, String? avatarPath, bool? onboarded, String? locale
});
...
/// Create a copy of UserEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? creationDate = freezed,Object? lastUpdateDate = freezed,Object? name = freezed,Object? email = freezed,Object? avatarPath = freezed,Object? onboarded = freezed,Object? locale = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id, @JsonKey(name: 'creation_date')@TimestampConverter()  DateTime? creationDate, @JsonKey(name: 'last_update_date')@TimestampConverter()  DateTime? lastUpdateDate,  String? name,  String? email,  String? avatarPath,  bool? onboarded,  String? locale)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case UserEntityData() when $default != null:
return $default(_that.id,_that.creationDate,_that.lastUpdateDate,_that.name,_that.email,_that.avatarPath,_that.onboarded,_that.locale);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(includeIfNull: false, toJson: Converters.id)  String? id, @JsonKey(name: 'creation_date')@TimestampConverter()  DateTime? creationDate, @JsonKey(name: 'last_update_date')@TimestampConverter()  DateTime? lastUpdateDate,  String? name,  String? email,  String? avatarPath,  bool? onboarded,  String? locale)  $default,) {final _that = this;
switch (_that) {
case UserEntityData():
return $default(_that.id,_that.creationDate,_that.lastUpdateDate,_that.name,_that.email,_that.avatarPath,_that.onboarded,_that.locale);}
}
...
class UserEntityData extends UserEntity {
  const UserEntityData({@JsonKey(includeIfNull: false, toJson: Converters.id) this.id, @JsonKey(name: 'creation_date')@TimestampConverter() this.creationDate, @JsonKey(name: 'last_update_date')@TimestampConverter() this.lastUpdateDate, this.name, this.email, this.avatarPath, this.onboarded, this.locale}): super._();
...
/// Create a copy of UserEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? creationDate = freezed,Object? lastUpdateDate = freezed,Object? name = freezed,Object? email = freezed,Object? avatarPath = freezed,Object? onboarded = freezed,Object? locale = freezed,}) {
